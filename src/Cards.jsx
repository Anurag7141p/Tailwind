...
const Cards = () => {
  return (
    <div>
      <h1 className="text-center mt-10 text-3xl font-serif text-tahiti">Our Services</h1>
      <hr className="w-1/5 mx-auto " />

      <div className="grid grid-cols-1 px-2  md:grid-cols-2 md:gap-3 lg:grid-cols-3 lg:gap-3 lg:px-3 justify-center">
        {/* first column */}
        <div className="py-10">
          <div className="rounded overflow-hidden  max-w-sm shadow-lg ">
            <img
            ...
            <div className="px-6 py-4">
              <h1 className="text-center font-serif font-bold">Mountain</h1>
              <p className="text-gray-700 pt-2 font-serif">
            ...
            <div className="px-6 pb-5 grid grid-flow-col gap-5">
              <span className="bg-gray-300 rounded-full text-center">
                #photography
              </span>
              <span className="bg-gray-300 rounded-full text-center">
                #winter
            ...
            <div className="text-center pb-4">
              <button className="bg-blue-500 text-gray-800 rounded-full px-3 py-1 capitalize hover:bg-blue-800  hover:text-gray-100 font-serif active:bg-cyan-400">
                View more
              </button>
            </div>
          </div>
